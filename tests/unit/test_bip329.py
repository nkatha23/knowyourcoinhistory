...
from kycc.labels.bip329 import serialize, deserialize, import_to_store
...
def test_spendable_field_preserved():
    jsonl = '{"type":"utxo","ref":"' + 'a'*64 + ':0","label":"test","spendable":false}'
    labels = deserialize(jsonl)
